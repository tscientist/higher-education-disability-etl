"""
Fase 4-6: Join SISU + Censo, Build Final Document, Calculate Metrics
...
class FaseJoinBuildMetrics:
    ...
    def build_final_document(self, curso_enriquecido, sisu_doc=None, year_range=None):
        ...
        from .fase_transform_censo import FaseTransformCenso
        fase2 = FaseTransformCenso()
        
        # Construir estruturas de referência
        ies_ref = fase2._build_ies_reference(ies_enrichment) if ies_enrichment else {}
        curso_ref = fase2._build_curso_reference(curso_enriquecido)
        indicadores_aluno = fase2._build_indicadores_aluno(curso_enriquecido)
        indicadores_deficiencia = fase2._build_indicadores_deficiencia(curso_enriquecido)
        indicadores_permanencia = fase2._build_indicadores_permanencia(curso_enriquecido)
